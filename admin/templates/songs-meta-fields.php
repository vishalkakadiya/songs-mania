...
<table>
    <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="sm-singer-email" name="sm_song_singer_email" value="<?php echo esc_attr( $singer_email );?>" class="sm-meta-field" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" id="sm-song-likes" name="sm_song_likes" value="<?php echo esc_attr( $likes );?>" class="sm-meta-field" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" id="sm-song-viewer" name="sm_song_viewer" value="<?php echo esc_attr( $viewers );?>" class="sm-meta-field" />
            </td>
        </tr>
</table>